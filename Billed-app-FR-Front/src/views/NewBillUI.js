            ...
            <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <div class="col-half">
                    ...
                    <input required type="file" class="form-control blue-border"  type="file" data-testid="file" accept=".jpg,.jpeg,.png" />
                    <div id="file-error-message" class="text-danger" style="display: none; margin-top: 5px;"></div>
                  </div>
                </div>
            </div>
            <div class="row">
